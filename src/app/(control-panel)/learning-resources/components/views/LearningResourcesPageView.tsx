...
import { getResources } from '@/api/services/learning';
...
function LearningResourcesPageView() {
	...
	const { data, isLoading, error } = useQuery({
		queryKey: ['learning-resources', payload],
		queryFn: () => getResources(payload),
		enabled: isReady
	});
...
export default LearningResourcesPageView;
