...
import { getAllSellerServices } from '@/api/services/sellers';
...
function ServicesPageView() {
	...
	const { data, isLoading, error } = useQuery({
		queryKey: ['seller-services', payload],
		queryFn: () => getAllSellerServices(payload),
		enabled: isReady
	});
						...
						<>
							<div className="flex flex-col divide-y rounded-xl border">
								{items.map((item: Record<string, unknown>, idx: number) => (
									<div
										key={(item.ServiceId as string | number) || idx}
